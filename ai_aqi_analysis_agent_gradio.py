...
def create_demo() -> gr.Blocks:
    ...
    with gr.Blocks(title="AQI Analysis Agent") as demo:
        ...
        with gr.Row():
            with gr.Column():
                city = gr.Textbox(label="City", placeholder="e.g., Sylhet")
                state = gr.Textbox(
                    label="State",
                    placeholder="Leave blank for Union Territories or US cities",
                    value=""
                )
                country = gr.Textbox(label="Country", value="Bangladesh")
        ...
        gr.Examples(
            examples=[
                ...
                ["Dhaka", "Dhaka", "Bangladesh", "respiratory issues", "evening commute"],
                ["Chittagong", "Chittagong", "Bangladesh", "asthma", "outdoor sports"],
                ["Sylhet", "Sylhet", "Bangladesh", "", "morning jog"]
            ],
